<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attempt3.aspx.cs" Inherits="wellness.attempt3" %>
...
<body>
    ...
    &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/testoption.aspx">&lt;---</asp:HyperLink>
        ...
        <asp:Label ID="Label1" runat="server" Font-Overline="False" Font-Size="15pt" 
            ForeColor="#420000" 
            Text="1.You felt so good or hyper that other people thought you were not your normal self or were so hyper that you got into trouble?"></asp:Label>
        <br />
        <asp:RadioButtonList ID="RadioButtonList1" runat="server" Font-Size="13pt" 
            ...
            <asp:ListItem Value="3">More Than Half The Days</asp:ListItem>
        </asp:RadioButtonList>
&nbsp;<asp:TextBox ID="TextBox1" runat="server" TextMode="Range" Width="371px"></asp:TextBox>
        ...
        <asp:Label ID="Label2" runat="server" Font-Overline="False" Font-Size="15pt" 
            ForeColor="#420000" 
            Text="2.You were so irritable that you shouted at people or started fights or arguments?"></asp:Label>
        <br />
...
&nbsp;<asp:TextBox ID="TextBox2" runat="server" TextMode="Range" Width="371px"></asp:TextBox>
        ...
        <asp:Label ID="Label3" runat="server" Font-Overline="False" Font-Size="15pt" 
            ForeColor="#420000" 
            Text="3.You were much more talkative or spoke much faster than usual?"></asp:Label>
        <br />
...
&nbsp;<asp:TextBox ID="TextBox3" runat="server" TextMode="Range" Width="371px"></asp:TextBox>
        ...
        <asp:Label ID="Label4" runat="server" Font-Overline="False" Font-Size="15pt" 
            ForeColor="#420000" 
            Text="4.You were so easily distracted by things around you that you had trouble concentrating or staying on track?"></asp:Label>
        <br />
...
&nbsp;<asp:TextBox ID="TextBox4" runat="server" TextMode="Range" Width="371px"></asp:TextBox>
        ...
        <asp:Label ID="Label5" runat="server" Font-Overline="False" Font-Size="15pt" 
            ForeColor="#420000" 
            Text="5.Thoughts raced through your head or you couldn’t slow your mind down?"></asp:Label>
        <br />
...
&nbsp;<asp:TextBox ID="TextBox5" runat="server" TextMode="Range" Width="371px"></asp:TextBox>
        ...
        <asp:Label ID="lbl_score3" runat="server" Font-Bold="True" Font-Size="XX-Large" 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <ul class="i8Z77e" 
            style="margin: 0px; padding: 0px; color: rgb(32, 33, 36); font-family: &quot;Google Sans&quot;, arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">
            <li class="TrT0Xe" 
                style="margin: 0px 0px 4px; padding: 0px; list-style-type: disc;">&quot;My recovery 
                from manic depression has been an evolution, not a sudden miracle&quot;</li>
        </ul>
        <br />
        <br />
        <br />
