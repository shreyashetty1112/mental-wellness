...
namespace wellness
{
    public partial class attempt3 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (RadioButtonList1.SelectedValue != null)
            {
                Label1.Text = ("Response: " + RadioButtonList1.SelectedItem.Text + "<br>")
                    + ("Bipolar: " + RadioButtonList1.SelectedValue + "<br>");
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (RadioButtonList2.SelectedValue != null)
            {
                Label2.Text = ("Response: " + RadioButtonList2.SelectedItem.Text + "<br>")
                    + ("Bipolar: " + RadioButtonList2.SelectedValue + "<br>");
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            if (RadioButtonList3.SelectedValue != null)
            {
                Label3.Text = ("Response: " + RadioButtonList3.SelectedItem.Text + "<br>")
                    + ("Bipolar: " + RadioButtonList3.SelectedValue + "<br>");
        ...
        protected void Button7_Click(object sender, EventArgs e)
        {
            if (RadioButtonList4.SelectedValue != null)
            {
                Label4.Text = ("Response: " + RadioButtonList4.SelectedItem.Text + "<br>")
                    + ("Bipolar: " + RadioButtonList4.SelectedValue + "<br>");
        ...
        protected void Button9_Click(object sender, EventArgs e)
        {
            if (RadioButtonList5.SelectedValue != null)
            {
                Label5.Text = ("Response: " + RadioButtonList5.SelectedItem.Text + "<br>")
                    + ("Bipolar: " + RadioButtonList5.SelectedValue + "<br>");
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            sum = a + b + c + d + z;
            //int sum = 100;
            lbl_score3.Text = sum.ToString();
            lbl_score3.Text = Convert.ToInt32(RadioButtonList1.SelectedValue) + Convert.ToInt32(RadioButtonList2.SelectedValue) + Convert.ToInt32(RadioButtonList3.SelectedValue) + Convert.ToInt32(RadioButtonList4.SelectedValue) + Convert.ToInt32(RadioButtonList5.SelectedValue).ToString();
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into attempt3 values('" + TextBox6.Text + "','" + RadioButtonList1.Text + "','" + RadioButtonList2.Text + "','" + RadioButtonList3.Text + "','" + RadioButtonList4.Text + "','" + RadioButtonList5.Text + "','" + lbl_score3.Text + "' )", con);
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        {
            Response.Redirect("abtbipolar.aspx");
        }
